...
class Linear(tf.keras.layers.Layer):
    def __init__(self, units=32, input_dim=32):
        ...
        self.custom_list = [3, 2, 3, 0, 4, 0, 0, 0, 4, 0, 0, 1, 3, 2, 4, 4, 3, 3, 4, 1, 2, 2, 3, 0, 4]
    ...
    def call(self, sem, mask):
        ...
        sum = 0
        sum = sum + tf.keras.layers.Activation('softmax')(t1) + tf.keras.layers.Activation('relu')(t2) + tf.keras.layers.Activation('softmax')(t3) + tf.keras.layers.Activation('sigmoid')(t4) + tf.keras.layers.Activation('sigmoid')(t6) + tf.keras.layers.Activation('sigmoid')(t7) + tf.keras.layers.Activation('sigmoid')(t8) + tf.keras.layers.Activation('sigmoid')(t10) + tf.keras.layers.Activation('sigmoid')(t11) + tf.keras.layers.Activation('tanh')(t12) + tf.keras.layers.Activation('softmax')(t13) + tf.keras.layers.Activation('relu')(t14) + tf.keras.layers.Activation('softmax')(t17) + tf.keras.layers.Activation('softmax')(t18) + tf.keras.layers.Activation('tanh')(t20) + tf.keras.layers.Activation('relu')(t21) + tf.keras.layers.Activation('relu')(t22) + tf.keras.layers.Activation('softmax')(t23) + tf.keras.layers.Activation('sigmoid')(t24)
