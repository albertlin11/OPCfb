...
def optimize_two_func(custom_list):
    ...
    score = main_two_repo_prof_ga.main(custom_list)
    print("score")
    print(score)
    return score
...
model=ga(function=optimize_two_func,dimension=25,variable_type='int',variable_boundaries=varbound, algorithm_parameters=algorithm_param)
