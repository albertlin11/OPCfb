...
class Linear(tf.keras.layers.Layer):
    def __init__(self, units=32, input_dim=32):
        ...
        self.custom_list = [4, 3, 0, 1, 3, 3, 4, 4, 2, 0, 3, 3, 0, 1, 3, 2, 4, 0, 1, 0, 0, 4, 2, 0, 0]
    ...
    def call(self, sem, mask):
        ...
        sum = 0
        sum = sum + tf.keras.layers.Activation('softmax')(t2) + tf.keras.layers.Activation('sigmoid')(t3) + tf.keras.layers.Activation('tanh')(t4) + tf.keras.layers.Activation('softmax')(t5) + tf.keras.layers.Activation('softmax')(t6) + tf.keras.layers.Activation('relu')(t9) + tf.keras.layers.Activation('sigmoid')(t10) + tf.keras.layers.Activation('softmax')(t11) + tf.keras.layers.Activation('softmax')(t12) + tf.keras.layers.Activation('sigmoid')(t13) + tf.keras.layers.Activation('tanh')(t14) + tf.keras.layers.Activation('softmax')(t15) + tf.keras.layers.Activation('relu')(t16) + tf.keras.layers.Activation('sigmoid')(t18) + tf.keras.layers.Activation('tanh')(t19) + tf.keras.layers.Activation('sigmoid')(t20) + tf.keras.layers.Activation('sigmoid')(t21) + tf.keras.layers.Activation('relu')(t23) + tf.keras.layers.Activation('sigmoid')(t24) + tf.keras.layers.Activation('sigmoid')(t25)
