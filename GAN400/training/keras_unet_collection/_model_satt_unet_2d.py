...
def UNET_att_right(X, X_left, channel, att_channel, kernel_size=3, stack_num=2,
    ...
    H = attention_gate(X=H, g=H, channel=att_channel, activation=atten_activation, 
                            attention=attention, name='{}_att_H'.format(name))
...
def att_unet_2d_base(input_tensor, filter_num, stack_num_down=2, stack_num_up=2,
                     ...
                     backbone=None, weights='imagenet', freeze_backbone=True, freeze_batch_norm=True, name='sattunet'):
    '''
...
def satt_unet_2d(input_size, filter_num, n_labels, stack_num_down=2, stack_num_up=2, activation='ReLU', 
