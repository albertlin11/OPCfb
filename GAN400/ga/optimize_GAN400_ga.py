...
import main_GAN400_repo_prof_ga
...
def optimize_GAN400_func(custom_list):
    ...
    score = main_GAN400_repo_prof_ga.main(custom_list)
    print("score")
    print(score)
    return score
...
model=ga(function=optimize_GAN400_func,dimension=25,variable_type='int',variable_boundaries=varbound, algorithm_parameters=algorithm_param)
