...
class Linear(tf.keras.layers.Layer):
    def __init__(self, units=32, input_dim=32):
        ...
        self.custom_list = [3, 4, 0, 0, 0, 4, 4, 4, 1, 1, 3, 0, 1, 4, 2, 0, 0, 1, 1, 1, 1, 3, 2, 0, 4]
    ...
    def call(self, sem, mask):
        ...
        sum = 0
        sum = sum + tf.keras.layers.Activation('softmax')(t1) + tf.keras.layers.Activation('sigmoid')(t3) + tf.keras.layers.Activation('sigmoid')(t4) + tf.keras.layers.Activation('sigmoid')(t5) + tf.keras.layers.Activation('tanh')(t9) + tf.keras.layers.Activation('tanh')(t10) + tf.keras.layers.Activation('softmax')(t11) + tf.keras.layers.Activation('sigmoid')(t12) + tf.keras.layers.Activation('tanh')(t13) + tf.keras.layers.Activation('relu')(t15) + tf.keras.layers.Activation('sigmoid')(t16) + tf.keras.layers.Activation('sigmoid')(t17) + tf.keras.layers.Activation('tanh')(t18) + tf.keras.layers.Activation('tanh')(t19) + tf.keras.layers.Activation('tanh')(t20) + tf.keras.layers.Activation('tanh')(t21) + tf.keras.layers.Activation('softmax')(t22) + tf.keras.layers.Activation('relu')(t23) + tf.keras.layers.Activation('sigmoid')(t24)
